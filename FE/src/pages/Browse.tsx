    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:fixed lg:left-0 lg:top-0 lg:h-full lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-white lg:p-5">
        ...
        <div className="flex flex-col space-y-4">
          <a href="#" className="flex items-center space-x-3 text-orange-500">
      ...
      <div className="lg:ml-64">
        ...
        <nav className="flex lg:hidden items-center justify-between px-5 mt-[30px]">
        ...
        <nav className="hidden lg:flex items-center justify-end px-8 py-4 bg-white border-b border-gray-200">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-[0_10px_20px_0_#D6D6D6AB] transition-all duration-300 hover:shadow-[0_10px_20px_0_#FF4C1C80]">
            <img src="/assets/images/icons/notification.svg" className="w-5 h-5 object-contain" alt="icon" />
          </div>
        </nav>
        ...
        {/* Search Form */}
        <div className="px-5 lg:px-8 mt-[30px]">
        ...
        <div className="lg:hidden fixed z-50 bottom-0 w-full max-w-[640px] mx-auto border-t border-[#E7E7E7] py-4 px-5 bg-white/70 backdrop-blur">
          <div className="flex items-center justify-evenly">
            ...
            <a href="#" className="nav-items">
              <div className="flex flex-col items-center text-center gap-[7px] text-sm leading-[21px]">
                <img src="/assets/images/icons/propil.svg" className="w-6 h-6" alt="icon" />
                <span>Profile</span>
              </div>
            </a>
          </div>
